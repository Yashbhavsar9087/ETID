...
def give_disease():
    ...
    # loaded_model = pickle.load(open(r'C:\Users\yashj\Desktop\YASH\PROJECT\PROJECT\UndisEASE_v5.0\UndisEASE_v5.0\xg1.sav', 'rb'))
    ...
    #     if i[0] == result[0][5]:
    #         precaution.append(i)
    return render_template('diagnosis.html', result=['This is the result','This is the result','This is the result'], precaution=['This is the precaution','This is the result','This is the result'], desc=['This is the desc','This is the result','This is the result'], syptoms_lst=syptoms_lst, symptoms=symptoms, segment='diagnosis')
